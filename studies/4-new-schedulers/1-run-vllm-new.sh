...
vllm serve /snfs1/llm-models/llama-3.2-3B-Instruct/ --host localhost --port 8000 --gpu-memory-utilization 0.28 --max-model-len 2000 --max-num-seqs $MNS --tensor-parallel-size 1 --kv-offloading-size 5 --disable-hybrid-kv-cache-manager --scheduler-cls $1
