...
vllm serve /snfs1/llm-models/llama-3.2-3B-Instruct/ --host localhost --port 8000 --gpu-memory-utilization 0.9 --max-model-len 10000 --max-num-seqs $MNS --tensor-parallel-size 1 --scheduler-cls $1
