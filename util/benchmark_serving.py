...
def main(args: argparse.Namespace):
    ...
    for i, sample_req in enumerate(input_requests):
        sample_req.prompt = f"[REQ{i}] " + sample_req.prompt
        sample_req.prompt_len = len(tokenizer(sample_req.prompt, add_special_tokens=False).input_ids)
