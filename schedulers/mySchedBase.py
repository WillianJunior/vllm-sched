...
class QuantumPreemptionPolicy(Enum):
    """Enum for preemption policies for RR, CFS, and EEVDF."""
...
class MyFCFSSched(SchedulerInterface):
    def __init__(
        ...
        # TODO: <=========================================================
        # HERE: just change the waiting queue....
    ...
    def schedule(self) -> SchedulerOutput:
            ...
            while True:
                ...
                if new_blocks is None:
                    ...
                    if self.policy == SchedulingPolicy.PRIORITY:
                        ...
                        if (
                            self.quantum_preempt_policy
                            != QuantumPreemptionPolicy.NONE
                        ):
                            self.running_quantum_steps.remove(preempted_req)
                    else:
                        preempted_req = self.running.pop()
                        if (
                            self.quantum_preempt_policy
        ...
        if not preempted_reqs:
            while self.waiting and token_budget > 0:
                ...
                if self.quantum_preempt_policy != QuantumPreemptionPolicy.NONE:
                    self.running_quantum_steps.append(0)
                if self.log_stats:
    ...
    def _try_schedule_encoder_inputs(
        ...
        for i, pos_info in enumerate(mm_positions):
            ...
            if (
                not self.encoder_cache_manager.can_allocate(request, i)
    ...
    def finish_requests(
        ...
        for request in running_requests_to_remove:
            ...
            if self.quantum_preempt_policy != QuantumPreemptionPolicy.NONE:
                self.running_quantum_steps.remove(request)
